	...
	<div id="menu-mng" class="lefter">
		<div class="box">
			<dl>
				...
				<dd><em><a href="${pageContext.request.contextPath}/manager/product?method=addUI">新增</a></em>
				<a href="${pageContext.request.contextPath}/manager/product?method=list">商品管理</a></dd>
				<dt>订单管理</dt>
				...
				<c:forEach var="p" items="${pageBean.data }">
					<tr>
						...
						<td class="thumb">
							...
							<a href="../product-view.html" target="_blank">${p.title }</a>
						</td>
						<td class="w1 c">
