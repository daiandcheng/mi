...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="${pageContext.request.contextPath}/pay" method=post
			target="_blank">
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDout_trade_no").value =  orderNo;
		document.getElementById("WIDsubject").value = sNow;
